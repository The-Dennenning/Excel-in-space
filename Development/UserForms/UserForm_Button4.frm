VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm_Button4 
   ClientHeight    =   5400
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   4710
   OleObjectBlob   =   "UserForm_Button4.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "UserForm_Button4"
...
End Sub
Private Sub CommandButton_Option4_Click()

UserForm_Button4.Hide
Call direct(Label2.caption, CommandButton_Option4.caption)
